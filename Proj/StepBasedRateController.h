 ...
 *
 */
class StepBasedRateController : public CvRtsp::IRateController
{
public:
    /**
     * @brief Constructor
     ...
     * bit-rate model.
     */
    virtual void controlBitrate(CvRtsp::SwitchDirection eSwitch)
    {
        switch (eSwitch)
        {
        case CvRtsp::SWITCH_DOWN:
        case CvRtsp::SWITCH_DOWN_MULTIPLE:
        {
        ...
        case CvRtsp::SWITCH_UP:
        case CvRtsp::SWITCH_UP_MULTIPLE:
        {
        ...
        case CvRtsp::SWITCH_DOWN_MIN:
        {
            m_uiFrameBitLimitIndex = 0;
            break;
        }
        case CvRtsp::SWITCH_UP_MAX:
        {
            m_uiFrameBitLimitIndex = static_cast<int>(m_vFrameBitLimits.size()) - 1;
            break;
        }
        default:
        {
