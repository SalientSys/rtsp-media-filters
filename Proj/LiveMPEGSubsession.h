...
namespace CvRtsp
{
	...
	class LiveMPEGSubsession : public LiveMediaSubsession
	{
	public:
		///
		/// Default constructor.
		...
		/// @param[in] configStr					Config-byte nedded by decoder.
		/// @param[in] profileAndLevelIndication	Profile-level-id needed by decoder.
		///
		...
		///
		/// Default destructor.
		virtual ~LiveMPEGSubsession() = default;
...
#pragma endregion 
	...
	private:
		/// Config string used by decoder for this mpeg4 stream.
		std::string m_configStr;

		/// profile-level-id used by decoderfor this mpeg4 stream.
		int m_profileAndLevelIndication;
	};
}
